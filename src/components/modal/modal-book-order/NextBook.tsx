...
const NextBook: React.FC = () => {
  const { nextBook, handleNext, slideDirection, isSliding } = useBookContext();
  const imageUrl = nextBook.img === "not available" ? ImageNotAvailable : nextBook.img;
